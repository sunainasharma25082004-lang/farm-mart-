export const services = [
  { id: 'farmart_mart', title: 'S-farmart Mart', subtitle: 'Daily Grocery & Staples', icon: 'basket-outline', color: '#16a34a', bg: '#dcfce7' },
...
export const products = [
  ...
  // 2. S-farmart Mart (Grocery & Daily Essentials)
  {
    id: 'p2',
    ...
    rating: 4.9,
    reviewsCount: 289,
    farmer: 'S-farmart Dairy Cooperative',
  ...
  },
  {
    ...
    rating: 4.6,
    reviewsCount: 42,
    farmer: 'S-farmart Community Bakery',
  ...
  },
  {
    ...
    rating: 4.9,
    reviewsCount: 175,
    farmer: 'S-farmart Heritage Sweets',
