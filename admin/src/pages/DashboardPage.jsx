...
export default function DashboardPage() {
  ...
  const fetchDashboardData = async () => {
    try {
      const response = await fetch('https://farm-mart-api.onrender.com/api/admin/data');
  ...
  const handleCreateSubAdmin = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch('https://farm-mart-api.onrender.com/api/admin/create-subadmin', {
        method: 'POST',
